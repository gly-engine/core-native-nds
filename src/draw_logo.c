...
void draw_logo()
{
    ...
    draw_queue_push(50, 90, 45, 50, 45);
#elif ENGINE_LOGO == 3
    static const uint8_t ver_x = 114;
    static const uint8_t ver_y = 80;
    gly_type_render(95, 45, 7, "GameBoy", draw_queue_clojure(51));
    gly_type_render(95, 53, 6, "Advanced", draw_queue_clojure(51));
    gly_type_render(95, 60, 13, "CORE", draw_queue_clojure(51));
    gly_type_render(95, 74, 5, "Native", draw_queue_clojure(51));
#endif
    gly_type_render(ver_x, ver_y, 5, "0.0.21", draw_queue_clojure(51));
    draw_queue_burn(1);
#endif
}
